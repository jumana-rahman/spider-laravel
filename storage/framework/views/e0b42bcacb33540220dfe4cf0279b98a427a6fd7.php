...
<head>
    ...
    <!-- Add site Favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('frontend_asset/images/favicon/favicon.ico')); ?>" type="image/png">
    <link rel="stylesheet" href="<?php echo e(asset('frontend_asset/css/vendor/vendor.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('frontend_asset/css/plugins/plugins.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('frontend_asset/css/style.min.css')); ?>">
...
<body>
                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="<?php echo e(asset('frontend_asset/images/logo/logo.png')); ?>" alt="Site Logo" /></a>
                        </div>
                    </div>
                                            ...
                                            <ul class="menu-banner w-100">
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            ...
                                                            src="<?php echo e(asset('frontend_asset/images/banner/7.jpg')); ?>" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
                                                            src="<?php echo e(asset('frontend_asset/images/banner/8.jpg')); ?>" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
                                                            src="<?php echo e(asset('frontend_asset/images/banner/9.jpg')); ?>" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            <?php if(auth()->guard('customerlogin')->check()): ?>
                                <div class="dropdown">
                                    <button class="btn dropdown-toggle header-action-btn login-btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                        <?php echo e(Auth::guard('customerlogin')->user()->name); ?>
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <a class="dropdown-item" href="<?php echo e(route('customer_logout')); ?>">Sign Out</a>
                                        </li>
                                    </ul>
                                </div>
                                <?php else: ?>
                                    <a href="<?php echo e(route('register')); ?>" class="header-action-btn login-btn"
                            ...
                            <a href="#offcanvas-cart"
                                ...
                                <span class="header-action-num"><?php echo e(App\Models\Cart::where('user_id', Auth::guard('customerlogin')->id())->count()); ?></span>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="<?php echo e(asset('frontend_asset/images/product-image/1.jpg')); ?>"
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="<?php echo e(asset('frontend_asset/images/product-image/2.jpg')); ?>"
                                alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="<?php echo e(asset('frontend_asset/images/product-image/3.jpg')); ?>"
                                alt="Cart product Image"></a>
                        <div class="content">
    ...
    <div id="offcanvas-cart" class="offcanvas offcanvas-cart">
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <?php $__currentLoopData = App\Models\Cart::where('user_id', Auth::guard('customerlogin')->id())->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="single-product.html" class="image"><img src="<?php echo e(asset('/uploads/products/preview')); ?>/<?php echo e($cart->rel_to_product->product_image); ?>"
                                alt="Cart product Image"></a>
                                <div class="content">
                                <a href="<?php echo e(route('product.details', $cart->product_id)); ?>" class="title"><?php echo e($cart->rel_to_product->product_name); ?></a>
                                <span class="quantity-price"><?php echo e($cart->quantity); ?> x <span class="amount">BDT <?php echo e($cart->rel_to_product->discount_price); ?></span></span>
                                <a href="<?php echo e(route('cart.delete', $cart->id)); ?>" class="remove">×</a>
                            </div>
                        </li>
            ...
            <div class="foot">
                <div class="buttons mt-30px">
                    <a href="<?php echo e(route('cart')); ?>" class="btn btn-dark btn-hover-primary mb-30px">view cart</a>
                        ...
                        <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="<?php echo e(asset('frontend_asset/images/logo/logo-white.png')); ?>" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    ...
                                    <img src="<?php echo e(asset('frontend_asset/images/icons/payment.png')); ?>" alt="" class="payment-img img-fulid">
    ...
    <script src="<?php echo e(asset('frontend_asset/js/vendor/vendor.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend_asset/js/plugins/plugins.min.js')); ?>"></script>
...
<?php /**PATH C:\Users\JUMANA\Laravel\spider\resources\views/frontend/master.blade.php ENDPATH**/ ?>