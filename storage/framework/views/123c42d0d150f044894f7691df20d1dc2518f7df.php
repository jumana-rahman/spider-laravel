                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="billing-info mb-4">
                                        ...
                                        <input type="text" name="name" value="<?php echo e(Auth::guard('customerlogin')->user()->name); ?>"/>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="billing-info mb-4">
                                        <label>Email</label>
                                        <input type="email" name="email" value="<?php echo e(Auth::guard('customerlogin')->user()->email); ?>"/>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="billing-info mb-4">
                            ...
                            <div class="your-order-wrap gray-bg-4">
                                <div class="your-order-product-info">
                                    ...
                                    <div class="your-order-middle">
                                        <ul>
                                            ...
                                            <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                                <li>
                                                    <span class="order-middle-left"><?php echo e($cart->rel_to_product->product_name); ?> X <?php echo e($cart->quantity); ?></span> 
                                                    <span class="order-price">BDT <?php echo e($cart->rel_to_product->discount_price*$cart->quantity); ?> </span>
                                                </li>
                                                <?php
                                    ...
                                    <div class="your-order-middle">
                                        <ul>
                                            <li>
                                                ...
                                                ?>
                                                <span class="order-price">BDT <?php echo e($discount); ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="your-order-total">
                                        <input type="hidden" id="total" value="<?php echo e($total - $discount); ?>">
                                        <ul>
                                            <li class="order-total">Total</li>
                                            <li id="grand_total">BDT <?php echo e($total - $discount); ?></li>
                                        </ul>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\JUMANA\Laravel\spider\resources\views/frontend/checkout.blade.php ENDPATH**/ ?>