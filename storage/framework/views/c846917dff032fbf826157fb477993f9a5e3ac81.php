        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="text-center pt-8 sm:justify-start sm:pt-0">
                    <h1 style="font-size:65px; color:teal;">Hi Everyone!! It's me Jumana here. Have a great day.</h1>
                </div>
...
<?php /**PATH C:\Users\JUMANA\Laravel\spider\resources\views/welcome.blade.php ENDPATH**/ ?>