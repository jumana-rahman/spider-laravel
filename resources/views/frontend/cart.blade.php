                                ...
                                <tbody>
                                    ...
                                    @forelse ($carts as $cart)
                                        <tr>
                                            ...
                                            <td class="product-price-cart"><span class="amount">BDT {{$cart->rel_to_product->discount_price}}</span></td>
                                            ...
                                            <td class="product-subtotal">BDT {{$cart->rel_to_product->discount_price*$cart->quantity}}</td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 mt-md-30px">
                            <div class="grand-totall">
                                ...
                                @endphp
                                <h5>Total Amount <span>BDT {{$total}}</span></h5>
                                <h5>Discount <span>{{$discount}}%</span></h5>
                                <h5>Discount Amount<span>BDT {{($total*$discount)/100}}</span></h5>

                                <h4 class="grand-totall-title">Grand Total <span>BDT {{$total-$after_discount}}</span></h4>
                                @php
                                    session([
