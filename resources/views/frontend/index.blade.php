                                                ...
                                                <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                                                    <div class="product-details-content quickview-content">
                                                        ...
                                                        <div class="pro-details-categories-info pro-details-same-style d-flex">
                                                            ...
                                                            <ul class="d-flex">
                                                                <li>
                                                                    <a href="#">{{App\Models\Category::find($category_product->category_id)->category_name}}.</a>
                                                                </li>
                                                                <li>
    ...
    <div class="row m-0">
        ...
        <div class="col-12 col-lg-4 mb-md-30px mb-lm-30px">
            <div class="single-banner-2">
                <img src="{{asset('/uploads/category/')}}/{{$top_category->category_image}}" alt="">
                <div class="item-disc">
                    <h4 class="title">{{$top_category->category_name}}</h4>
                            ...
                            <div class="new-product-wrapper swiper-wrapper">
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('uploads/products/preview/')}}/{{$new_product->product_image}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                                @if ($new_product->discount)
                                                <span class="sale">-{{$new_product->discount}}%</span>
                                                @endif
                                            </span>
                                            <div class="actions">
                                                <a href="wishlist.html" class="action wishlist" title="Wishlist"><i
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title">
                                                <a href="single-product.html">{{$new_product->product_name}}</a>
                                            </h5>
                                            <span class="price">
                                                <span class="new">BDT {{$new_product->product_image}}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="new-product-wrapper swiper-wrapper">
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('frontend_asset/images/product-image/8.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('frontend_asset/images/product-image/9.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('frontend_asset/images/product-image/10.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('frontend_asset/images/product-image/11.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('frontend_asset/images/product-image/3.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="sale">-10%</span>
                                                <span class="new">New</span>
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('frontend_asset/images/product-image/1.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 mb-md-30px mb-lm-30px">
                <div class="single-blog">
                    <div class="blog-image">
                        <a href="blog-single-left-sidebar.html"><img src="{{asset('frontend_asset/images/blog-image/1.jpg')}}"
            ...
            <div class="col-lg-4 mb-md-30px mb-lm-30px">
                <div class="single-blog ">
                    <div class="blog-image">
                        <a href="blog-single-left-sidebar.html"><img src="{{asset('frontend_asset/images/blog-image/2.jpg')}}"
                                class="img-responsive w-100" alt=""></a>
                    </div>
                    <div class="blog-text">
                        <div class="blog-athor-date">
            ...
            <div class="col-lg-4">
                <div class="single-blog">
                    <div class="blog-image">
                        <a href="blog-single-left-sidebar.html"><img src="{{asset('frontend_asset/images/blog-image/3.jpg')}}"
                                class="img-responsive w-100" alt=""></a>
                    </div>
                    <div class="blog-text">
                        <div class="blog-athor-date">
