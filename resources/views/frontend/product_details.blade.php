            ...
            <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                <form action="{{url('/cart/insert')}}" method="POST">
                    ...
                    <div class="product-details-content quickview-content">
                        ...
                        @if (App\Models\Inventory::where('product_id', $product_info->id)->where('color_id',6)->exists())
                        ...
                        @endif
                        <!-- Sidebar single item -->
                        @if (App\Models\Inventory::where('product_id', $product_info->id)->where('size_id',7)->exists())
                        ...
                        <div class="pro-details-quality">
                            ...
                            <div class="pro-details-cart">
                                ...
                                @else
                                <a class="add-cart" href="{{route('register')}}"> Add To Cart</a>
                                @endauth 
                            </div>
                    ...
                    <div class="product">
                        <div class="thumb">
                            <a href="single-product.html" class="image">
                                <img src="{{('/uploads/products/preview')}}/{{$related_product->product_image}}" alt="Product" />
                            </a>
                            <span class="badges">
                        ...
                        <div class="content">
                            ...
                            <h5 class="title"><a href="{{route('product.details', $related_product->id)}}">{{$related_product->product_name}}
                                </a>
                            </h5>
                            <span class="price">
                                <span class="new">BDT {{$related_product->discount_price}}</span>
                            </span>
                        </div>
                    </div>
                </div>
