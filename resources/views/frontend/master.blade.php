...
<head>
    ...
    <!-- Add site Favicon -->
    <link rel="shortcut icon" href="{{asset('frontend_asset/images/favicon/favicon.ico')}}" type="image/png">
    <link rel="stylesheet" href="{{asset('frontend_asset/css/vendor/vendor.min.css')}}" />
    <link rel="stylesheet" href="{{asset('frontend_asset/css/plugins/plugins.min.css')}}" />
...
<body>
                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="{{asset('frontend_asset/images/logo/logo.png')}}" alt="Site Logo" /></a>
                        </div>
                    </div>
                                            ...
                                            <ul class="menu-banner w-100">
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            ...
                                                            src="{{asset('frontend_asset/images/banner/7.jpg')}}" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
                                                            src="{{asset('frontend_asset/images/banner/8.jpg')}}" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
                                                            src="{{asset('frontend_asset/images/banner/9.jpg')}}" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                            ...
                            @auth('customerlogin')
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <a class="dropdown-item" href="{{route('customer_logout')}}">Sign Out</a>
                                        </li>
                                    </ul>
                                </div>
                                @else
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('frontend_asset/images/product-image/1.jpg')}}"
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('frontend_asset/images/product-image/2.jpg')}}"
                                alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('frontend_asset/images/product-image/3.jpg')}}"
                                alt="Cart product Image"></a>
                        <div class="content">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    @foreach (App\Models\Cart::where('user_id', Auth::guard('customerlogin')->id())->get() as $cart)
                        <li>
                            <a href="single-product.html" class="image"><img src="{{asset('/uploads/products/preview')}}/{{$cart->rel_to_product->product_image}}"
                                alt="Cart product Image"></a>
                                <div class="content">
                                <a href="{{route('product.details', $cart->product_id)}}" class="title">{{$cart->rel_to_product->product_name}}</a>
                                <span class="quantity-price">{{$cart->quantity}} x <span class="amount">BDT {{$cart->rel_to_product->discount_price}}</span></span>
                                <a href="{{route('cart.delete', $cart->id)}}" class="remove">×</a>
                            </div>
                        </li>
                    @endforeach
                </ul>
                        ...
                        <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{asset('frontend_asset/images/logo/logo-white.png')}}" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    ...
                                    <img src="{{asset('frontend_asset/images/icons/payment.png')}}" alt="" class="payment-img img-fulid">
    ...
    <script src="{{asset('frontend_asset/js/vendor/vendor.min.js')}}"></script>
    <script src="{{asset('frontend_asset/js/plugins/plugins.min.js')}}"></script>
