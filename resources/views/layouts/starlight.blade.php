...
<html lang="en">
  <head>
    ...
    <title>Spider - @yield('title')</title>
  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{url('/subcategory')}}" class="nav-link">Add subcategory</a></li>
        </ul>
        ...
        <!-- Color & Size -->
        <a href="#" class="sl-menu-link @yield('color_size')">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('color.size')}}" class="nav-link">Add Color and Size</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{url('coupon')}}" class="nav-link">Add Coupon</a></li>
        </ul>
